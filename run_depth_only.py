...
if __name__ == '__main__':
    ...
    relative_model_path = r'checkpoints\depth_anything_vitb14'
    model_directory = os.path.join(current_script_directory, relative_model_path)
    print(f"Model directory {model_directory}")
    depth_anything = DepthAnything.from_pretrained(model_directory, local_files_only=True).to(DEVICE).eval()    
